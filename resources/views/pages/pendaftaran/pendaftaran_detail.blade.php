        ...
        <div class="container-fluid">
            <div class="page-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Detail Calon Penerima Manfaat</li>
                </ol>
            </div>
        </div>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h5>Detail Calon Penerima Manfaat</h5>
                            <span>Detail calon penerima manfaat yang telah mendaftakna diri</span>
                        </div>
                        <div class="card-body">
                            <!-- ANAK -->
